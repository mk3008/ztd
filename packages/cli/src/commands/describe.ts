...
export const COMMANDS = [
  ...
  { name: 'query optional add', summary: 'Add an optional search condition branch and refresh query metadata.', useCase: 'Make an optional search condition explicit in SQL while keeping runtime behavior metadata-backed.' },
  { name: 'query optional refresh', summary: 'Refresh optional-condition metadata after SQL edits.', useCase: 'Regenerate metadata when the SQL still owns the intended optional filter shape.' },
  { name: 'query optional remove', summary: 'Remove an optional search condition branch and refresh query metadata.', useCase: 'Delete optional-condition scaffolding without hand-editing metadata.' },
